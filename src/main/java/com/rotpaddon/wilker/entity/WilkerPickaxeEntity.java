...
public class WilkerPickaxeEntity extends ModdedProjectileEntity {

    public WilkerPickaxeEntity(EntityType<WilkerPickaxeEntity> type, World world) {
        super(type, world);
    }
    
    public WilkerPickaxeEntity(LivingEntity shooter, World world) {
        super(InitEntities.WILKER_PICKAXE.get(), shooter, world);
    }
