...
public class WilkerPickaxeModel extends EntityModel<WilkerPickaxeEntity> {
	private final ModelRenderer pickaxe;

	public WilkerPickaxeModel() {
		texWidth = 32;
		texHeight = 32;
	...
	@Override
	public void setupAnim(WilkerPickaxeEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
